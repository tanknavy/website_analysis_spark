...
public class UserVisitSessionAnalyzeSpark3 {
	...
	public static void main(String[] args) throws AnalysisException{
		...
		*/
		...
		randomExtracSession(taskid, filteredSessionid2AggrInfoRDD); //Test：
	...
	private static void randomExtracSession(final long taskid, JavaPairRDD<String, String> sessionid2AggrInfoRDD) {
		...
		JavaRDD<String> sessionSampleRDD = sessionbyHourRDD.flatMap(new FlatMapFunction<Tuple2<String,Iterable<String>>, String>() {
			private static final long serialVersionUID = 1L;
			public Iterator<String> call(Tuple2<String, Iterable<String>> tuple2) throws Exception {
				// 要返回Iterator对象
				List<String> extractSessionids = new ArrayList<>();
				//日期时间
