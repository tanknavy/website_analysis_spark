...
public class UserVisitSessionAnalyzeSpark5 {
	...
	*/
	...
	private static void getTop10Category(
		...
		*/
		...
		JavaPairRDD<Long, Long> clickCategory2CountRDD = getClickCategory2CountRDD(session2ActionRDD);
		JavaPairRDD<Long, Long> orderategory2CountRD = getOrderategory2CountRDD(session2ActionRDD);
		JavaPairRDD<Long, Long> payCategory2CountRDD = getPayCategory2CountRDD(session2ActionRDD);
